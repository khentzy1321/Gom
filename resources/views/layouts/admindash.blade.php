...
<div class="wrapper">
  ...
  <div id="spinner-anim">
    <div class="loader">
        ...
        <div class="loading-text">Loading<span class="dots">.</span><span class="dots">.</span><span class="dots">.</span></div>
      </div>
  </div>
...
{{-- <script>
    $(document).ready(function() {
      toastr.success('This is a test message!', 'Success', { "progressBar": true });
    });
  </script> --}}
</body>
